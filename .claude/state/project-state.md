...
- **Pause runbook added 2026-05-01:** `docs/runbooks/pause-legacy-calendly-poll.md` gives the reversible procedure used for Scheduler job `calendly-poll`. Pause only the Scheduler trigger, not the Cloud Run Job or legacy tables.
- **`calendly-poll` Scheduler paused 2026-05-01:** execution log at `docs/runbooks/pause-legacy-calendly-poll-execution-2026-05-01.md`. Only the `dee-data-ops-prod` Cloud Scheduler trigger was paused; Cloud Run Job, image, secrets, and legacy BigQuery tables remain intact. Immediate/current-state verification was healthy; no post-pause execution was created.
...
- **Calendly pause runbook:** `docs/runbooks/pause-legacy-calendly-poll.md` — reversible procedure for the first legacy pause.
- **Calendly pause execution log:** `docs/runbooks/pause-legacy-calendly-poll-execution-2026-05-01.md` — records the actual pause and watch status.
