...
- [ ] U1. **Cutover preflight — audit GTM's GCP + inventory what's missing in Merge CI**
...
- Create: `docs/preflight/gtm-gcp-inventory.md` (one-time snapshot; contents generated by the checks below)
